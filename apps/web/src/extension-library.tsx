                ...
                {extensions.map((extension) => (
                  ...
                  >
                    <header>
                      <div>
                        <span>
                          {extension.source === "built_in" ? "BUILT IN" : "LOCAL MANIFEST"}
                        </span>
