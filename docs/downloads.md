...
Mac M 系列现提供 **v0.2.0-beta.11 调试版**，升级工作流选择、资产库和画布操作体验；其余平台保留 **beta.4**。选择自己的电脑，只需下载一个安装包。
...
也可查看 [Mac M 系列 beta.11](https://github.com/Fourques/Takeboard/releases/tag/v0.2.0-beta.11) 和[其他平台 beta.4](https://github.com/Fourques/Takeboard/releases/tag/v0.2.0-beta.4) 的发布页面。
