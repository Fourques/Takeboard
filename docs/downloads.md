...
Mac M 系列现提供 **v0.2.0-beta.13 调试版**，改进资产定位、结果素材跳转和详情布局；其余平台保留 **beta.4**。选择自己的电脑，只需下载一个安装包。
...
也可查看 [Mac M 系列 beta.13](https://github.com/Fourques/Takeboard/releases/tag/v0.2.0-beta.13) 和[其他平台 beta.4](https://github.com/Fourques/Takeboard/releases/tag/v0.2.0-beta.4) 的发布页面。
