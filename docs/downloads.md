...
Mac M 系列现提供 **v0.2.0-beta.10 调试版**，升级模板检查、推荐配置添加和镜头详情体验；其余平台保留 **beta.4**。选择自己的电脑，只需下载一个安装包。
...
也可查看 [Mac M 系列 beta.10](https://github.com/Fourques/Takeboard/releases/tag/v0.2.0-beta.10) 和[其他平台 beta.4](https://github.com/Fourques/Takeboard/releases/tag/v0.2.0-beta.4) 的发布页面。
...
- 旧 `0.2.0-beta.2` 需先手动下载安装新版。此后可在“更新 → 检查更新”检查后续版本；不自动安装，远端应用也需单独升级。
