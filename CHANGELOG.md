...
- Explicit high-density WebGL buffer synchronization keeps the three-dimensional director board
  crisp after layout changes, browser zoom and software-renderer initialization.
